...
LOCAL_CFLAGS := -Wall -Wextra -Wno-unused-parameter -DFFMPEG_KIT_${MY_ARCH_FLAGS}
...
MY_CFLAGS := -Wall -Wno-unused-parameter -Wno-switch -Wno-sign-compare -Wno-single-bit-bitfield-constant-conversion
